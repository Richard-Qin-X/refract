file (GLOB_RECURSE REFRACT_CC_FILES ${CMAKE_SOURCE_DIR}/src/*.cc)
...
foreach (tidy_target ${ALL_SRC_FILES})
  ...
  if (${tidy_target} IN_LIST REFRACT_CC_FILES)
    list (APPEND REFRACT_TIDY_TARGETS tidy_${tidy_target_name})
  endif ()
endforeach (tidy_target)

add_custom_target (tidy DEPENDS ${REFRACT_TIDY_TARGETS})
